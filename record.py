...
def lane_detection(img, prediction):
	...
	hj.publish(bridge.cv2_to_imgmsg(prediction, 'bgr8'))
...
# 	KF = kalman.KalmanFilter(A = A, H = H, Q = Q, R = R)
	...
	hj = rospy.Publisher('/hj', Image, queue_size=1)
